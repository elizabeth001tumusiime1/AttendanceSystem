...
let AttendanceController = class AttendanceController {
    ...
    markAttendance(records, req) {
        const markedById = req.user?.userId;
        return this.attendanceService.markAttendance(records, markedById);
    }
    findAll(studentId, classId, startDate, endDate) {
    ...
    update(id, record) {
        return this.attendanceService.updateRecord(+id, record);
    }
};
